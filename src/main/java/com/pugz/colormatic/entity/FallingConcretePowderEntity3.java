...
public class FallingConcretePowderEntity3 extends Entity {
    ...
    protected static final DataParameter<BlockPos> ORIGIN = EntityDataManager.createKey(FallingConcretePowderEntity3.class, DataSerializers.BLOCK_POS);

    public FallingConcretePowderEntity3(EntityType<? extends FallingConcretePowderEntity3> p_i50218_1_, World p_i50218_2_) {
        super(p_i50218_1_, p_i50218_2_);
    }

    public FallingConcretePowderEntity3(World worldIn, double x, double y, double z, BlockState fallingBlockState) {
        this(ColormaticEntities.FALLING_CONCRETE_POWDER_3, worldIn);
    ...
    /**
     * returns if this entity triggers Block.onEntityWalking on the block they walk on. used for spiders and wolves to
