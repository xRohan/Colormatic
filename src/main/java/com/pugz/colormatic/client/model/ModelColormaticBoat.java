package com.pugz.colormatic.client.model;
...
@OnlyIn(Dist.CLIENT)
public class ModelColormaticBoat extends EntityModel<ColormaticBoatEntity> {
    private final RendererModel[] body = new RendererModel[5];
    private final RendererModel[] paddles = new RendererModel[2];
    private final RendererModel noWater;

    public ModelColormaticBoat() {
        body[0] = (new RendererModel(this, 0, 0)).setTextureSize(128, 64);
        body[1] = (new RendererModel(this, 0, 19)).setTextureSize(128, 64);
        body[2] = (new RendererModel(this, 0, 27)).setTextureSize(128, 64);
        body[3] = (new RendererModel(this, 0, 35)).setTextureSize(128, 64);
        body[4] = (new RendererModel(this, 0, 43)).setTextureSize(128, 64);
        body[0].addBox(-14.0F, -9.0F, -3.0F, 28, 16, 3, 0.0F);
        body[0].setRotationPoint(0.0F, 3.0F, 1.0F);
        body[1].addBox(-13.0F, -7.0F, -1.0F, 18, 6, 2, 0.0F);
        body[1].setRotationPoint(-15.0F, 4.0F, 4.0F);
        body[2].addBox(-8.0F, -7.0F, -1.0F, 16, 6, 2, 0.0F);
        body[2].setRotationPoint(15.0F, 4.0F, 0.0F);
        body[3].addBox(-14.0F, -7.0F, -1.0F, 28, 6, 2, 0.0F);
        body[3].setRotationPoint(0.0F, 4.0F, -9.0F);
        body[4].addBox(-14.0F, -7.0F, -1.0F, 28, 6, 2, 0.0F);
        body[4].setRotationPoint(0.0F, 4.0F, 9.0F);
        body[0].rotateAngleX = ((float)Math.PI / 2F);
        body[1].rotateAngleY = ((float)Math.PI * 1.5F);
        body[2].rotateAngleY = ((float)Math.PI / 2F);
    ...
    public void render(ColormaticBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    protected void renderPaddle(ColormaticBoatEntity boat, int paddle, float scale, float limbSwing) {
